...
class BeresourceController extends BeController{
    ...
    public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('Manage Resource'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('Add Resource'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
	...
	{         
              ...
              $this->menu=array_merge($this->menu,                       
                        array(
                            array('label'=>t('Update this Resource'), 'url'=>array('update','id'=>$id),'linkOptions'=>array('class'=>'button')),
                            array('label'=>t('View this Resource'), 'url'=>array('view','id'=>$id),'linkOptions'=>array('class'=>'button'))
                        )
                    );
