...
define('SITE_NAME_URL','http://localhost/sample/frontend/index.php');
define('SUPPORT_EMAIL','support@localhost');
define('FRONT_SITE_URL','http://localhost/sample/frontend/index.php');
define('BACKEND_SITE_URL','http://localhost/sample/backend/index.php');
