...
define('RESOURCE_URL','http://localhost/Sample-Project/resources'); 
define('AVATAR_URL','http://localhost/Sample-Project/avatar');  
define('SITE_NAME','GXC-CMS Demo TEST ZONE');
define('SLOGAN','We build apps for better life experience');
define('SITE_NAME_URL','http://localhost/Sample-Project/frontend/index-test.php');
define('SUPPORT_EMAIL','support@localhost');
define('FRONT_SITE_URL','http://localhost/Sample-Project/frontend/index-test.php');
define('BACKEND_SITE_URL','http://localhost/Sample-Project/backend/index-test.php');
